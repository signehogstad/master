%-----------------------------------------------------------------------
% Job saved on 07-Feb-2023 15:21:34 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.spatial.normalise.est.subj.vol = {'/Users/signehogstad/masterproject/LC_mask.nii,1'};
...
matlabbatch{1}.spm.spatial.normalise.est.eoptions.tpm = {'/Users/signehogstad/spm12/tpm/TPM.nii'};
